#pragma once
      ...
      #define MY_NEURAL_NETWORK_LIB__CUDA_API
    #else
      #define MY_NEURAL_NETWORK_LIB__API
      #define MY_NEURAL_NETWORK_LIB__CUDA_API __declspec(dllexport)
    #endif
  #else
    #define MY_NEURAL_NETWORK_LIB__API __declspec(dllimport)
    #define MY_NEURAL_NETWORK_LIB__CUDA_API __declspec(dllimport)
  #endif
#else
  #define MY_NEURAL_NETWORK_LIB__API
  #define MY_NEURAL_NETWORK_LIB__CUDA_API
