#pragma once
      ...
      #define MY_NEURAL_NETWORK_LIB__PLUGINCORE__CUDA_API
    #else
      #define MY_NEURAL_NETWORK_LIB__PLUGINCORE__API
      #define MY_NEURAL_NETWORK_LIB__PLUGINCORE__CUDA_API __declspec(dllexport)
    #endif
  #else
    #define MY_NEURAL_NETWORK_LIB__PLUGINCORE__API __declspec(dllimport)
    #define MY_NEURAL_NETWORK_LIB__PLUGINCORE__CUDA_API __declspec(dllimport)
  #endif
#else
  #define MY_NEURAL_NETWORK_LIB__PLUGINCORE__API
  #define MY_NEURAL_NETWORK_LIB__PLUGINCORE__CUDA_API
